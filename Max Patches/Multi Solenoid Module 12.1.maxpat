...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 15.0, 20.0, 500.0, 33.0 ],
									"style" : "",
...
,
					"patching_rect" : [ 1071.0, 427.0, 59.0, 22.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 503.0, 242.0, 87.0, 22.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 192.75, 405.0, 87.0, 22.0 ],
					"style" : "",
					"text" : "s cc_message"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1037.0, 251.0, 87.0, 22.0 ],
					"style" : "",
					"text" : "s cc_message"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 1093.0, 315.0, 24.0, 24.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1093.0, 286.0, 72.0, 22.0 ],
					"style" : "",
					"text" : "loadmess 1"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 1043.0, 318.0, 42.0, 18.0 ],
					"preset_data" : [ 						{
							"number" : 1,
							"data" : [ 5, "obj-165", "number", "int", 50, 5, "obj-163", "umenu", "int", 0 ]
						}
 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 192.75, 373.0, 86.0, 22.0 ],
					"style" : "",
					"text" : "s perc_ontime"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 192.75, 306.5, 73.0, 22.0 ],
					"style" : "",
					"text" : "s PAM_pick"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 192.75, 273.25, 112.0, 22.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 927.25, 301.0, 73.0, 22.0 ],
					"style" : "",
					"text" : "s perc_note"
				}
...
,
					"patching_rect" : [ 978.0, 411.0, 56.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 1145.0, 19.0, 71.0, 22.0 ],
									"style" : "",
									"text" : "r perc_note"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 1057.75, 19.0, 78.0, 22.0 ],
									"style" : "",
									"text" : "r perc_mode"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 1220.5, 134.0, 84.0, 22.0 ],
									"style" : "",
									"text" : "r perc_ontime"
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "", "bang" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 1220.5, 169.0, 50.0, 22.0 ],
									"style" : ""
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 1145.0, 230.0, 94.5, 22.0 ],
									"style" : "",
									"text" : "pack 0 0"
								}
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 1145.0, 198.0, 94.5, 22.0 ],
									"style" : "",
									"text" : "makenote"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "int", "int" ],
									"patching_rect" : [ 1145.0, 105.0, 69.0, 22.0 ],
									"style" : "",
									"text" : "unpack 0 0"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "int", "int" ],
									"patching_rect" : [ 1145.0, 134.0, 57.0, 22.0 ],
									"style" : "",
									"text" : "stripnote"
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "", "bang" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 1023.0, 191.5, 50.0, 22.0 ],
									"style" : ""
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 1023.0, 159.5, 112.0, 22.0 ],
									"style" : "",
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 3,
									"outlettype" : [ "", "", "" ],
									"patching_rect" : [ 1057.75, 53.0, 44.0, 22.0 ],
									"style" : "",
									"text" : "gate 3"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 985.0, 256.5, 56.0, 22.0 ],
									"style" : "",
									"text" : "pack 0 0"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "float", "float" ],
									"patching_rect" : [ 985.0, 224.5, 63.0, 22.0 ],
									"style" : "",
									"text" : "makenote"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "int", "int" ],
									"patching_rect" : [ 985.0, 94.0, 69.0, 22.0 ],
									"style" : "",
									"text" : "unpack 0 0"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "int", "int" ],
									"patching_rect" : [ 985.0, 123.0, 57.0, 22.0 ],
									"style" : "",
									"text" : "stripnote"
								}
...
,
					"patching_rect" : [ 978.0, 482.0, 44.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
,
					"patching_rect" : [ 978.0, 444.0, 46.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					"allowdrag" : 0,
					"id" : "obj-7",
					"items" : [ "Bluetooth-Incoming-Port", ",", "usbserial-AL00FQ7X", ",", "usbserial-A104JSQI", ",", "usbmodem1A12431" ],
					"maxclass" : "umenu",
					"numinlets" : 1,
					"numoutlets" : 3,
					"outlettype" : [ "int", "", "" ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 374.5, 53.0, 86.0, 90.0 ],
					"presentation" : 1,
					"presentation_linecount" : 4,
					"presentation_rect" : [ 47.0, 172.5, 105.0, 73.0 ],
					"style" : "",
					"text" : "MIDI channel\n1 Cyther\n2 PAM\n3 Percussion"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 900.25, 233.0, 85.0, 22.0 ],
					"style" : "",
					"text" : "s Cyther_note"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 192.75, 339.75, 73.0, 22.0 ],
					"style" : "",
					"text" : "s perc_note"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 192.75, 240.0, 75.0, 22.0 ],
					"style" : "",
					"text" : "s PAM_note"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 912.75, 265.0, 75.0, 22.0 ],
					"style" : "",
					"text" : "s PAM_note"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 900.25, 199.0, 44.0, 22.0 ],
					"style" : "",
					"text" : "gate 3"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 327.75, 22.0, 307.0, 266.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 17.5, 127.0, 317.0, 308.0 ],
					"proportion" : 0.39,
					"style" : ""
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 1092.5, 165.0, 1065.25, 165.0, 1065.25, 87.0, 1080.25, 87.0, 1080.25, 9.0, 766.75, 9.0 ],
					"source" : [ "obj-144", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 735.75, 108.0, 755.25, 108.0, 755.25, 81.0, 770.25, 81.0 ],
					"source" : [ "obj-145", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 766.75, 45.0, 828.25, 45.0, 828.25, 119.0, 1124.0625, 119.0 ],
					"source" : [ "obj-15", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 735.75, 45.0, 828.25, 45.0, 828.25, 118.0, 1092.5, 118.0 ],
					"source" : [ "obj-22", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 735.75, 147.0, 777.25, 147.0, 777.25, 120.0, 792.0, 120.0 ],
					"source" : [ "obj-342", 0 ]
				}
